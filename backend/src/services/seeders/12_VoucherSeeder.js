...
class VoucherSeeder {
  static async run() {
    ...
    try {
      ...
      const promotionIds = promotionResult.recordset.map(
      ...
      for (const voucher of vouchers) {
        await pool
          ...
          .input('Promotion_ID', voucher.Promotion_ID).query(`
                        INSERT INTO Voucher (
