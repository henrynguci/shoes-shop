  ...
  const vouchers = [
    {
      id: 1,
      title: 'Free Shipping',
      description: 'Giảm tới đa 15k - Đơn Tối Thiểu 40k',
      condition: 'Chỉ có trên Live',
      limit: '3',
    },
    {
      id: 2,
      title: 'Free Shipping',
      description: 'Giảm tới đa 50k - Đơn Tối Thiểu 200k',
      condition: 'Dành cho khách hàng thân thiết',
    },
  ];
